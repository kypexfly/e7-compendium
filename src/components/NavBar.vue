	...
	<nav class="bg-white border-gray-200 fix-padding dark:bg-gray-900/30 sticky top-0 z-10 w-full backdrop-blur">
		<div class="container flex flex-wrap justify-between items-center mx-auto">
			...
			<div class="hidden w-full md:block md:w-auto" id="mobile-menu">
				<ul
					class="flex flex-col p-2 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:mt-0 md:text-[0.9rem] md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-700/30 dark:border-gray-700">
					<li>
						<router-link to="/"
